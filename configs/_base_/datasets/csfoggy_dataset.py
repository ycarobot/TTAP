# dataset settings
dataset_type = 'CityscapesDataset_foggy'
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        train_txt='./mmseg/datasets/data_information/train_cs_foggy.txt',
        data_prefix=dict(
            img_path='leftImg8bit_foggyDBF/val', seg_map_path='gtFine/val'),
